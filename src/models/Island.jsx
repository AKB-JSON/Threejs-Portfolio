  ...
  return (
    <a.group ref={islandRef} {...props} scale={0.38}>
      <group position={[-42.281, -1.801, 11.779]} rotation={[0, -0.185, 0]}>
        ...
        <mesh geometry={nodes.Final_Bridge1_SF_LampGlass_Mat_0.geometry} material={materials.SF_LampGlass_Mat} />
        <mesh geometry={nodes.Final_Bridge1_SF_Lamp_Mat_0.geometry} material={materials.SF_Lamp_Mat} />
        <mesh geometry={nodes.Final_Bridge1_SF_Candle_Mat_0.geometry} material={materials.SF_Candle_Mat} />
